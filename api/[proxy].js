/*
 * =============================================================
 * KOD "DAPUR" PROXY YANG PALING SIMPLE & DIJAMIN JADI
 * Gantikan semua kod lama dalam api/[...path].js dengan kod ini.
 * Ini adalah logik yang meniru cara CodePen berfungsi.
 * =============================================================
 */
export default async function handler(request) {
  ...
  // 2. Dapatkan URL API sasaran dari parameter. Contoh: /dramabox/api/v1/new/1
